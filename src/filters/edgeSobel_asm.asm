...
;xmm8 = 2*(p7-p7)|...|2*(p0-p0)(word)(2*(fila inferior- fila superior))
			pslldq xmm7, 2;shift 1 word
;xmm7 = p6-p6|...|p2-p2|p1-p1|p0-p0|0(word)(fila inferior- fila superior)
			psrldq xmm9, 2;shift 1 word 
;xmm9 = 0|p7-p7|p6-p6|...|p2-p2|p1-p1(word)(fila inferior- fila superior)
			paddsw xmm8, xmm9
;xmm8 = 2*(p7-p7)|2*(p6-p6)+(p7-p7)|2*(p5-p5)+(p6-p6)|...|2*(p0-p0)+(p1-p1)(word)(2*(fila inferior- fila superior))
			paddsw xmm8, xmm7
;xmm8 = 2*(p7-p7)+(p6-p6)|2*(p6-p6)+(p7-p7)+(p5-p5)|2*(p5-p5)+(p7-p7)+(p6-p6)|...|2*(p1-p1)+(p2-p2)+(p0-p0)|2*(p0-p0)+(p1-p1)(word)(2*(fila inferior- fila superior))			
			;Operador Y en xmm8
